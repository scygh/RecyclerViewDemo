package com.scy.recyclerviewdemo.gird;
...
import com.scy.recyclerviewdemo.footer.RcvFooterAdapter;
...
public class GirdActivity extends AppCompatActivity {
    @BindView(R.id.rcv_gird)
    RecyclerView rcvGird;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcvGird.setLayoutManager(new GridLayoutManager(this,2));
        rcvGird.setHasFixedSize(true);
        //rcvGird.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL));
        rcvGird.setAdapter(adapter);
